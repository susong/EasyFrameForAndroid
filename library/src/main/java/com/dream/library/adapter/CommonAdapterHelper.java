...
public class CommonAdapterHelper {
    ...
    public CommonAdapterHelper setVisibleOrGone(int viewId, boolean visible) {
        View view = getView(viewId);
        view.setVisibility(visible ? View.VISIBLE : View.GONE);
        return this;
    }

    public CommonAdapterHelper setVisibleOrInvisible(int viewId, boolean visible) {
        View view = getView(viewId);
        view.setVisibility(visible ? View.VISIBLE : View.INVISIBLE);
        return this;
    }

    public CommonAdapterHelper setInvisibleOrGone(int viewId, boolean visible) {
        View view = getView(viewId);
