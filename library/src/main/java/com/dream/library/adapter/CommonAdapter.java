...
public abstract class CommonAdapter<T> extends BaseAdapter {
    ...
    public void addAllFirst(List<T> elemList) {
        mList.addAll(0, elemList);
        notifyDataSetChanged();
    }

    public void addAllLast(List<T> elemList) {
        mList.addAll(mList.size(), elemList);
        notifyDataSetChanged();
    }
